...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Reservation_SDK) DeepCopyInto(out *Reservation_SDK) {
	*out = *in
	if in.Groups != nil {
		in, out := &in.Groups, &out.Groups
		*out = make([]*GroupIdentifier, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Reservation_SDK.
func (in *Reservation_SDK) DeepCopy() *Reservation_SDK {
	if in == nil {
		return nil
	}
	out := new(Reservation_SDK)
	in.DeepCopyInto(out)
	return out
}
