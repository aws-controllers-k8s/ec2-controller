...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Status.InternetGatewayID = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	tmp, ok := fields["internetGatewayID"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: internetGatewayID"))
	}
	r.ko.Status.InternetGatewayID = &tmp
