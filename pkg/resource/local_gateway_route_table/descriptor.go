...
const (
	FinalizerString = "finalizers.ec2.services.k8s.aws/LocalGatewayRouteTable"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("localgatewayroutetables")
	GroupKind            = metav1.GroupKind{
		Group: "ec2.services.k8s.aws",
		Kind:  "LocalGatewayRouteTable",
	}
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.LocalGatewayRouteTable{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.LocalGatewayRouteTable),
	}
}
