...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=localgatewayroutetables,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=localgatewayroutetables/status,verbs=get;update;patch
