...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Status.FleetID = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	primaryKey, ok := fields["fleetID"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: fleetID"))
	}
	r.ko.Status.FleetID = &primaryKey
