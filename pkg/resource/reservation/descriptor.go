...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/Reservation"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("reservations")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.Reservation{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.Reservation),
	}
}
