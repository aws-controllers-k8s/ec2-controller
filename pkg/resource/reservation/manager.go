...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=reservations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=reservations/status,verbs=get;update;patch
