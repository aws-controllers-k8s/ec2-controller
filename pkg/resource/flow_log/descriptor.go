...
const (
	FinalizerString = "finalizers.ec2.services.k8s.aws/FlowLog"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("flowlogs")
