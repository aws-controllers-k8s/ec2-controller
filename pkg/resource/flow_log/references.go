...
func (rm *resourceManager) ClearResolvedReferences(res acktypes.AWSResource) acktypes.AWSResource {
	...
	if ko.Spec.DeliverLogsPermissionRef != nil {
...
func (rm *resourceManager) ResolveReferences(
	...
	if fieldHasReferences, err := rm.resolveReferenceForDeliverLogsPermissionARN(ctx, apiReader, ko); err != nil {
		return &resource{ko}, (resourceHasReferences || fieldHasReferences), err
	} else {
		resourceHasReferences = resourceHasReferences || fieldHasReferences
	}

	if fieldHasReferences, err := rm.resolveReferenceForLogGroupName(ctx, apiReader, ko); err != nil {
		return &resource{ko}, (resourceHasReferences || fieldHasReferences), err
	} else {
		resourceHasReferences = resourceHasReferences || fieldHasReferences
	}
...
// identifier field.
func validateReferenceFields(ko *svcapitypes.FlowLog) error {

	if ko.Spec.DeliverLogsPermissionRef != nil && ko.Spec.DeliverLogsPermissionARN != nil {
		return ackerr.ResourceReferenceAndIDNotSupportedFor("DeliverLogsPermissionARN", "DeliverLogsPermissionRef")
	}

	if ko.Spec.LogGroupRef != nil && ko.Spec.LogGroupName != nil {
		return ackerr.ResourceReferenceAndIDNotSupportedFor("LogGroupName", "LogGroupRef")
	}
	return nil
}

// resolveReferenceForDeliverLogsPermissionARN reads the resource referenced
// from DeliverLogsPermissionRef field and sets the DeliverLogsPermissionARN
// from referenced resource. Returns a boolean indicating whether a reference
// contains references, or an error
func (rm *resourceManager) resolveReferenceForDeliverLogsPermissionARN(
	ctx context.Context,
	apiReader client.Reader,
	ko *svcapitypes.FlowLog,
) (hasReferences bool, err error) {
	if ko.Spec.DeliverLogsPermissionRef != nil && ko.Spec.DeliverLogsPermissionRef.From != nil {
		hasReferences = true
		arr := ko.Spec.DeliverLogsPermissionRef.From
		if arr.Name == nil || *arr.Name == "" {
			return hasReferences, fmt.Errorf("provided resource reference is nil or empty: DeliverLogsPermissionRef")
		}
		...
		ko.Spec.DeliverLogsPermissionARN = (*string)(obj.Status.ACKResourceMetadata.ARN)
	}
...
// resolveReferenceForLogGroupName reads the resource referenced
// from LogGroupRef field and sets the LogGroupName
// from referenced resource. Returns a boolean indicating whether a reference
// contains references, or an error
func (rm *resourceManager) resolveReferenceForLogGroupName(
	ctx context.Context,
	apiReader client.Reader,
	ko *svcapitypes.FlowLog,
) (hasReferences bool, err error) {
	if ko.Spec.LogGroupRef != nil && ko.Spec.LogGroupRef.From != nil {
		...
		ko.Spec.LogGroupName = (*string)(obj.Spec.Name)
	}
