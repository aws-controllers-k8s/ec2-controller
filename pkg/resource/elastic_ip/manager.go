...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=elasticips,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=elasticips/status,verbs=get;update;patch
