...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/ElasticIP"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("elasticips")
