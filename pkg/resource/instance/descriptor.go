...
const (
	FinalizerString = "finalizers.ec2.services.k8s.aws/Instance"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("instances")
