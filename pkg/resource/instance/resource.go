...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Status.InstanceID = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	tmp, ok := fields["instanceID"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: instanceID"))
	}
	r.ko.Status.InstanceID = &tmp
