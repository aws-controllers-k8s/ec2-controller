...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/ElasticIPAddress"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("elasticipaddresses")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ElasticIPAddress{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ElasticIPAddress),
	}
}
