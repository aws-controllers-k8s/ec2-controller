...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=elasticipaddresses,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=elasticipaddresses/status,verbs=get;update;patch
