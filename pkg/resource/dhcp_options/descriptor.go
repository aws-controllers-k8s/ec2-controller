...
const (
	finalizerString = "finalizers.ec2.services.k8s.aws/DHCPOptions"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("dhcpoptions")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.DHCPOptions{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.DHCPOptions),
	}
}
