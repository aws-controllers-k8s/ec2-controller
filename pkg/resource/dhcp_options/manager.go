...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=dhcpoptions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=dhcpoptions/status,verbs=get;update;patch
