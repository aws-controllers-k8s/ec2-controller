...
func (rm *resourceManager) ClearResolvedReferences(res acktypes.AWSResource) acktypes.AWSResource {
	...
	if ko.Spec.Data != nil {
		for f0idx, f0iter := range ko.Spec.Data.BlockDeviceMappings {
			if f0iter.EBS != nil {
				if f0iter.EBS.KMSKeyRef != nil {
					ko.Spec.Data.BlockDeviceMappings[f0idx].EBS.KMSKeyID = nil
				}
			}
		}
	}
...
func (rm *resourceManager) ResolveReferences(
	...
	if fieldHasReferences, err := rm.resolveReferenceForData_BlockDeviceMappings_EBS_KMSKeyID(ctx, apiReader, ko); err != nil {
...
func validateReferenceFields(ko *svcapitypes.LaunchTemplate) error {
	...
	if ko.Spec.Data != nil {
		for _, f0iter := range ko.Spec.Data.BlockDeviceMappings {
			if f0iter.EBS != nil {
				if f0iter.EBS.KMSKeyRef != nil && f0iter.EBS.KMSKeyID != nil {
					return ackerr.ResourceReferenceAndIDNotSupportedFor("Data.BlockDeviceMappings.EBS.KMSKeyID", "Data.BlockDeviceMappings.EBS.KMSKeyRef")
				}
			}
		}
	}
...
// resolveReferenceForData_BlockDeviceMappings_EBS_KMSKeyID reads the resource referenced
// from Data.BlockDeviceMappings.EBS.KMSKeyRef field and sets the Data.BlockDeviceMappings.EBS.KMSKeyID
// from referenced resource. Returns a boolean indicating whether a reference
// contains references, or an error
func (rm *resourceManager) resolveReferenceForData_BlockDeviceMappings_EBS_KMSKeyID(
	ctx context.Context,
	apiReader client.Reader,
	...
	if ko.Spec.Data != nil {
		for f0idx, f0iter := range ko.Spec.Data.BlockDeviceMappings {
			if f0iter.EBS != nil {
				if f0iter.EBS.KMSKeyRef != nil && f0iter.EBS.KMSKeyRef.From != nil {
					hasReferences = true
					arr := f0iter.EBS.KMSKeyRef.From
					if arr.Name == nil || *arr.Name == "" {
						return hasReferences, fmt.Errorf("provided resource reference is nil or empty: Data.BlockDeviceMappings.EBS.KMSKeyRef")
					}
					...
					ko.Spec.Data.BlockDeviceMappings[f0idx].EBS.KMSKeyID = (*string)(obj.Status.ACKResourceMetadata.ARN)
				}
			}
		}
	}
