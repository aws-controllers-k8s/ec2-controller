...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Status.ServiceID = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	primaryKey, ok := fields["serviceID"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: serviceID"))
	}
	r.ko.Status.ServiceID = &primaryKey
