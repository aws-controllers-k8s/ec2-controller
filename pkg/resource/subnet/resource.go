...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Status.SubnetID = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	tmp, ok := fields["subnetID"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: subnetID"))
	}
	r.ko.Status.SubnetID = &tmp
