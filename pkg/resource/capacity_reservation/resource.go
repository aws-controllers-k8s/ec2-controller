...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	tmp, ok := fields["capacityReservationID"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: capacityReservationID"))
	}
	r.ko.Status.CapacityReservationID = &tmp
