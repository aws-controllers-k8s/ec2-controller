...
func (rm *resourceManager) customUpdateEgressOnlyInternetGateway(
	ctx context.Context,
	desired *resource,
	latest *resource,
	...
	exit := rlog.Trace("rm.customUpdateEgressOnlyInternetGateway")
...
func updateTagSpecificationsInCreateRequest(r *resource,
	...
	if r.ko.Spec.Tags != nil {
		...
		desiredTagSpecs.ResourceType = "egress-only-internet-gateway"
